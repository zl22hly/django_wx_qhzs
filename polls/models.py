...
class Park(models.Model):
    ...
    naturalLevel = models.CharField(max_length=40, verbose_name="自然级别", choices=naturalLevel_CHOICE)
    ParkLevel = models.CharField(max_length=40, verbose_name="级别划分", choices=ParkLevel_CHOICE)
    numbering = models.CharField(max_length=40, verbose_name="编号")
    ...
    introduceMP4 = models.CharField(max_length=600, verbose_name="介绍影片")
    ...
    area = models.CharField(max_length=40, verbose_name="片区", choices=area_CHOICE)
    city = models.CharField(max_length=20, verbose_name="市", choices=city_CHOICE)
    county = models.CharField(max_length=60, verbose_name="县")
    scenery = models.CharField(max_length=400, verbose_name="景点")
